...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrollAreaWidget.setEnabled(False)
        self.scrollAreaWidget.setGeometry(QtCore.QRect(0, 0, 1237, 556))
        self.scrollAreaWidget.setObjectName("scrollAreaWidget")
        self.scrollArea.setWidget(self.scrollAreaWidget)
        self.ParametersSettingVLayout.addWidget(self.scrollArea)
